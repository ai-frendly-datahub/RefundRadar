...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        ...
        {
            "name": "case_finder",
            "description": "Find refund or dispute cases matching a query from recent articles.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string"},
        ...
        {
            "name": "quality_report",
            "description": "Build the refund claim/resolution data-quality report.",
            "inputSchema": {
                "type": "object",
                "properties": {
...
def _call_tool_handler(name: str, arguments: object) -> str:
    ...
    if name == "quality_report":
        return handle_quality_report(
            db_path=_db_path(),
            category=str(args.get("category", "refund")),
            days=_as_int(args.get("days"), 30),
