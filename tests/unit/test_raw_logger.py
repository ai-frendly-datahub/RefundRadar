...
Article = cast(Any, import_module("refundradar.models").Article)
RawLogger = cast(Any, import_module("refundradar.raw_logger").RawLogger)


def _make_article(*, title: str = "Sample title", summary: str = "요약") -> Any:
    return Article(
        title=title,
